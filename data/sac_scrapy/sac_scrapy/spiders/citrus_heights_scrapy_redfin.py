...
class SacSpider(scrapy.Spider):
    name = "citrus_spider_redfin"
    start_urls = [
        f'https://www.redfin.com/city/3539/CA/Citrus-Heights'
        ]
    page_number = 2
    ...
    def parse(self, response):
        ...
        next_page = f'https://www.redfin.com/city/3539/CA/Citrus-Heights/page-{str(self.page_number)}'
