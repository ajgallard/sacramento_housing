...
class SacSpider(scrapy.Spider):
    name = "rancho_spider_redfin"
    start_urls = [
        f'https://www.redfin.com/city/15387/CA/Rancho-Cordova'
        ]
    page_number = 2
    ...
    def parse(self, response):
        ...
        next_page = f'https://www.redfin.com/city/15387/CA/Rancho-Cordova/page-{str(self.page_number)}'
